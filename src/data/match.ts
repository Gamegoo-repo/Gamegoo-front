export const MATCH_PAGE_DATA = [
    // { id: 1, pathname: 'match', width: '580px', height: '285px', top: '50%', left: '50%', title: '바로 매칭하기', background: "/assets/images/card/matching.svg" },
    // { id: 2, pathname: 'board', width: '580px', height: '285px', top: '50%', left: '50%', title: '매칭 게시판에서 찾기', background: "/assets/images/card/board.svg" },
    { id: 1, pathname: 'match', image: '/assets/images/home_image1.svg', title: '바로 매칭하기' },
    { id: 2, pathname: 'board', image: '/assets/images/home_image2.svg', title: '매칭 게시판에서 찾기' },
];
...
// export const MATCH_TYPE_PAGE_DATA = [
//     { id: 1, type: 'fun', pathname: 'match/game-mode', width: '600px', height: '380px', top: '50%', left: '50%', title: '즐겜' },
//     { id: 2, type: 'hard', pathname: 'match/game-mode', width: '600px', height: '380px', top: '50%', left: '50%', title: '빡겜' },
// ];
