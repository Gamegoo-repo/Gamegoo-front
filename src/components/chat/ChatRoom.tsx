...
const MESSAGE_LIST = [
  {
    user: "me",
    msg: "안녕하세요 저는 안녕하세요 저는 안녕하세요 저는",
    msgId: 1,
    userId: 1,
    date: "2024-05-01T23:25:00",
  },
  {
    user: "me",
    msg: "텍스트 텍스",
    msgId: 2,
    userId: 1,
    date: "2024-05-11T23:27:00",
  },
  {
    user: "you",
    msg: "아 네, 안녕하세요 하이하이라라",
    msgId: 3,
    userId: 2,
    date: "2024-07-02T01:08:00",
  },
  {
    user: "you",
    msg: "하이하이라라하이하이라라하이하이라라하이하이라라하이하이라라하이하이라라하이하이라라하이하이라라",
    msgId: 4,
    userId: 2,
    date: "2024-07-02T01:11:00",
  },
  {
    user: "me",
    msg: "안녕하세요 저는 안녕하세요 저는 안녕하세요 저는22",
    msgId: 5,
    userId: 1,
    date: "2024-07-02T23:27:00",
  },
  {
    user: "me",
    msg: "텍스트 텍스22",
  ...
  {
    user: "you",
    msg: "아 네, 안녕하세요 하이하이라라22",
    msgId: 7,
    userId: 2,
    date: "2024-07-04T22:52:00",
  },
  {
    user: "you",
    msg: "하이하이라라하이하이라라하이하이라라하이하이라라하이하이라라하이하이라라하이하이라라하이하이라라22",
    msgId: 8,
    userId: 2,
    date: "2024-07-04T22:52:00",
  },
...
const ChatRoom = (props: ChatRoomProps) => {
  ...
  const isMannerStatus = useSelector(
    (state: RootState) => state.mannerStatus.mannerStatus
  );
  const isMoreModalType = useSelector(
  ...
  return (
    <>
      <Overlay>
        ...
        >
          {isMoreBoxOpen && <MiniModal onChangeModal={handleModalChange} />}
          <CloseButton>
            <CloseImage
              onClick={onClose}
          ...
          <ChatBorder>
            <ChatMain>
              ...
              <MessageContainer messageList={MESSAGE_LIST} />
            </ChatMain>
          </ChatBorder>
          <ChatFooter>
            <TextareaContainer>
      ...
      {isEvaluationModalOpen && (
        <FormContainer>
          <FormModal
            type="checkbox"
            title={
              isMannerStatus === "manner" ? "매너 평가하기" : "비매너 평가하기"
            }
            width="418px"
            height="434px"
            closeButtonWidth={17}
...
const Wrapper = styled.div<{ $isFeedbackModalOpen: boolean }>`
  ...
  &:before {
    content: "";
    position: ${({ $isFeedbackModalOpen }) =>
      $isFeedbackModalOpen ? "fixed" : "unset"};
    top: 0;
    left: 0;
    width: 100%;
    height: 100%;
    background: ${({ $isFeedbackModalOpen }) =>
      $isFeedbackModalOpen ? "#0000009C" : "transparent"};
    z-index: 100;
    border-radius: 20px;
  }
`;
