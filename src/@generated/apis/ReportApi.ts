...
export interface ReportApiInterface {
   ...
   */
  addReportRaw(
    requestParameters: AddReportRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<runtime.ApiResponse<ApiResponseReportInsertResponse>>;
  ...
  addReport(
    requestParameters: AddReportRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<ApiResponseReportInsertResponse>;
   ...
   * @memberof ReportApiInterface
   */
  deleteReportedPostRaw(
    requestParameters: DeleteReportedPostRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
   ...
   */
  getReportListRaw(
    requestParameters: GetReportListRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<runtime.ApiResponse<ApiResponseReportPageResponse>>;
  ...
  getReportList(
    requestParameters: GetReportListRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<ApiResponseReportPageResponse>;
   ...
   */
  processReportRaw(
    requestParameters: ProcessReportRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<runtime.ApiResponse<ApiResponseReportProcessResponse>>;
  ...
  processReport(
    requestParameters: ProcessReportRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<ApiResponseReportProcessResponse>;
}
...
export class ReportApi extends runtime.BaseAPI implements ReportApiInterface {
  ...
  async addReportRaw(
    ...
    const response = await this.request(
      {
        path: `/api/v2/report/{memberId}`.replace(
          `{${"memberId"}}`,
  ...
  async deleteReportedPostRaw(
    ...
    const response = await this.request(
      {
        path: `/api/v2/report/{reportId}/post`.replace(
          `{${"reportId"}}`,
  ...
  async deleteReportedPost(
    ...
    const response = await this.deleteReportedPostRaw(
      requestParameters,
      initOverrides
    );
    return await response.value();
  ...
  async getReportListRaw(
    ...
    if (requestParameters["reportedMemberKeyword"] != null) {
      queryParameters["reportedMemberKeyword"] =
        requestParameters["reportedMemberKeyword"];
    }
    ...
    if (requestParameters["reportCountExact"] != null) {
      queryParameters["reportCountExact"] =
        requestParameters["reportCountExact"];
    }
  ...
  async getReportList(
    ...
    const response = await this.getReportListRaw(
      requestParameters,
      initOverrides
    );
    return await response.value();
  ...
  async processReportRaw(
    ...
    const response = await this.request(
      {
        path: `/api/v2/report/{reportId}/process`.replace(
          `{${"reportId"}}`,
          encodeURIComponent(String(requestParameters["reportId"]))
        ),
        method: "PUT",
  ...
  async processReport(
    ...
    const response = await this.processReportRaw(
      requestParameters,
      initOverrides
    );
    return await response.value();
