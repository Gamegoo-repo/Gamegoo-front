...
export interface RefreshChampionStatsRequest {
    memberId?: number;
}
...
export interface MemberApiInterface {
     ...
     * @memberof MemberApiInterface
     */
    refreshChampionStatsRaw(requestParameters: RefreshChampionStatsRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<ApiResponseMyProfileResponse>>;

    /**
     * API for refreshing champion statistics
     * 챔피언 통계 새로고침 API 입니다.
     */
    refreshChampionStats(requestParameters: RefreshChampionStatsRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<ApiResponseMyProfileResponse>;
...
export class MemberApi extends runtime.BaseAPI implements MemberApiInterface {
     ...
     * 챔피언 통계 새로고침 API 입니다.
     */
    async refreshChampionStatsRaw(requestParameters: RefreshChampionStatsRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<ApiResponseMyProfileResponse>> {
        const queryParameters: any = {};
     ...
     * 챔피언 통계 새로고침 API 입니다.
     */
    async refreshChampionStats(requestParameters: RefreshChampionStatsRequest = {}, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<ApiResponseMyProfileResponse> {
        const response = await this.refreshChampionStatsRaw(requestParameters, initOverrides);
        return await response.value();
    }
