...
export interface PasswordControllerApiInterface {
   ...
   */
  checkPasswordRaw(
    requestParameters: CheckPasswordRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<runtime.ApiResponse<ApiResponsePasswordCheckResponse>>;
  ...
  checkPassword(
    requestParameters: CheckPasswordRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<ApiResponsePasswordCheckResponse>;
   ...
   * @memberof PasswordControllerApiInterface
   */
  resetPasswordWithJWTRaw(
    requestParameters: ResetPasswordWithJWTRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<runtime.ApiResponse<ApiResponseString>>;
 ...
 *
 */
export class PasswordControllerApi
  extends runtime.BaseAPI
  implements PasswordControllerApiInterface
{
  /**
   * API for checking password
   * 비밀번호 확인 API 입니다.
   */
  async checkPasswordRaw(
    requestParameters: CheckPasswordRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<runtime.ApiResponse<ApiResponsePasswordCheckResponse>> {
  ...
  async checkPassword(
    ...
    const response = await this.checkPasswordRaw(
      requestParameters,
      initOverrides
    );
  ...
  async resetPasswordWithJWT(
    ...
    const response = await this.resetPasswordWithJWTRaw(
      requestParameters,
      initOverrides
    );
    return await response.value();
