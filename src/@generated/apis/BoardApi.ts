...
export interface BoardApiInterface {
   ...
   */
  boardInsertRaw(
    requestParameters: BoardInsertOperationRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<runtime.ApiResponse<ApiResponseBoardInsertResponse>>;
  ...
  boardInsert(
    requestParameters: BoardInsertOperationRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<ApiResponseBoardInsertResponse>;
   ...
   */
  boardListRaw(
    requestParameters: BoardListRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<runtime.ApiResponse<ApiResponseBoardResponse>>;
  ...
  boardList(
    requestParameters: BoardListRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<ApiResponseBoardResponse>;
   ...
   */
  boardUpdateRaw(
    requestParameters: BoardUpdateOperationRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<runtime.ApiResponse<ApiResponseBoardUpdateResponse>>;
  ...
  boardUpdate(
    requestParameters: BoardUpdateOperationRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<ApiResponseBoardUpdateResponse>;
   ...
   */
  bumpBoardRaw(
    requestParameters: BumpBoardRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<runtime.ApiResponse<ApiResponseBoardBumpResponse>>;
  ...
  bumpBoard(
    requestParameters: BumpBoardRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<ApiResponseBoardBumpResponse>;
   ...
   */
  deleteGuestBoardRaw(
    requestParameters: DeleteGuestBoardRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<runtime.ApiResponse<ApiResponseString>>;
  ...
  getBoardByIdRaw(
    ...
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<runtime.ApiResponse<ApiResponseBoardByIdResponse>>;
  ...
  getBoardById(
    requestParameters: GetBoardByIdRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<ApiResponseBoardByIdResponse>;
   ...
   * @memberof BoardApiInterface
   */
  getBoardByIdForMemberRaw(
    requestParameters: GetBoardByIdForMemberRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<runtime.ApiResponse<ApiResponseBoardByIdResponseForMember>>;
  ...
  getBoardByIdForMember(
    requestParameters: GetBoardByIdForMemberRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<ApiResponseBoardByIdResponseForMember>;
   ...
   * @memberof BoardApiInterface
   */
  getBoardsWithCursorRaw(
    requestParameters: GetBoardsWithCursorRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<runtime.ApiResponse<ApiResponseBoardCursorResponse>>;
  ...
  getBoardsWithCursor(
    requestParameters: GetBoardsWithCursorRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<ApiResponseBoardCursorResponse>;
   ...
   * @memberof BoardApiInterface
   */
  getMyBoardCursorListRaw(
    requestParameters: GetMyBoardCursorListRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<runtime.ApiResponse<ApiResponseMyBoardCursorResponse>>;
  ...
  getMyBoardCursorList(
    requestParameters: GetMyBoardCursorListRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<ApiResponseMyBoardCursorResponse>;
   ...
   */
  getMyBoardListRaw(
    requestParameters: GetMyBoardListRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<runtime.ApiResponse<ApiResponseMyBoardResponse>>;
  ...
  getMyBoardList(
    requestParameters: GetMyBoardListRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<ApiResponseMyBoardResponse>;
   ...
   */
  guestBoardInsertRaw(
    requestParameters: GuestBoardInsertOperationRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<runtime.ApiResponse<ApiResponseBoardInsertResponse>>;
   ...
   */
  guestBoardUpdateRaw(
    requestParameters: GuestBoardUpdateOperationRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<runtime.ApiResponse<ApiResponseBoardUpdateResponse>>;
...
export class BoardApi extends runtime.BaseAPI implements BoardApiInterface {
  ...
  async _deleteRaw(
    ...
    const response = await this.request(
      {
        path: `/api/v2/posts/{boardId}`.replace(
          `{${"boardId"}}`,
  ...
  async boardInsert(
    ...
    const response = await this.boardInsertRaw(
      requestParameters,
      initOverrides
    );
    return await response.value();
  ...
  async boardUpdate(
    ...
    const response = await this.boardUpdateRaw(
      requestParameters,
      initOverrides
    );
    return await response.value();
  ...
  async bumpBoardRaw(
    ...
    const response = await this.request(
      {
        path: `/api/v2/posts/{boardId}/bump`.replace(
          `{${"boardId"}}`,
          encodeURIComponent(String(requestParameters["boardId"]))
        ),
        method: "POST",
  ...
  async deleteGuestBoardRaw(
    ...
    const response = await this.request(
      {
        path: `/api/v2/posts/guest/{boardId}`.replace(
          `{${"boardId"}}`,
          encodeURIComponent(String(requestParameters["boardId"]))
        ),
        method: "DELETE",
   ...
   * 비회원 게시판 글 삭제 API
   */
  async deleteGuestBoard(
    requestParameters: DeleteGuestBoardRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<ApiResponseString> {
    const response = await this.deleteGuestBoardRaw(
      requestParameters,
      initOverrides
    );
    return await response.value();
  ...
  async getBoardByIdRaw(
    ...
    const response = await this.request(
      {
        path: `/api/v2/posts/list/{boardId}`.replace(
          `{${"boardId"}}`,
          encodeURIComponent(String(requestParameters["boardId"]))
        ),
        method: "GET",
   ...
   * 회원용 게시판 글 조회 API
   */
  async getBoardByIdForMemberRaw(
    requestParameters: GetBoardByIdForMemberRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<runtime.ApiResponse<ApiResponseBoardByIdResponseForMember>> {
    if (requestParameters["boardId"] == null) {
    ...
    const response = await this.request(
      {
        path: `/api/v2/posts/member/list/{boardId}`.replace(
          `{${"boardId"}}`,
          encodeURIComponent(String(requestParameters["boardId"]))
        ),
        method: "GET",
   ...
   * 회원용 게시판 글 조회 API
   */
  async getBoardByIdForMember(
    requestParameters: GetBoardByIdForMemberRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<ApiResponseBoardByIdResponseForMember> {
    const response = await this.getBoardByIdForMemberRaw(
      requestParameters,
      initOverrides
    );
    return await response.value();
   ...
   * 커서 기반 게시판 글 목록 조회 API
   */
  async getBoardsWithCursor(
    requestParameters: GetBoardsWithCursorRequest = {},
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<ApiResponseBoardCursorResponse> {
    const response = await this.getBoardsWithCursorRaw(
      requestParameters,
      initOverrides
    );
    return await response.value();
   ...
   * 내가 작성한 게시판 글 목록 조회 API/모바일
   */
  async getMyBoardCursorList(
    requestParameters: GetMyBoardCursorListRequest = {},
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<ApiResponseMyBoardCursorResponse> {
    const response = await this.getMyBoardCursorListRaw(
      requestParameters,
      initOverrides
    );
    return await response.value();
  ...
  async getMyBoardList(
    ...
    const response = await this.getMyBoardListRaw(
      requestParameters,
      initOverrides
    );
    return await response.value();
   ...
   * 비회원 게시판 글 작성 API
   */
  async guestBoardInsert(
    requestParameters: GuestBoardInsertOperationRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<ApiResponseBoardInsertResponse> {
    const response = await this.guestBoardInsertRaw(
      requestParameters,
      initOverrides
    );
    return await response.value();
   ...
   * 비회원 게시판 글 수정 API
   */
  async guestBoardUpdate(
    requestParameters: GuestBoardUpdateOperationRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<ApiResponseBoardUpdateResponse> {
    const response = await this.guestBoardUpdateRaw(
      requestParameters,
      initOverrides
    );
    return await response.value();
