...
export const deletePostsBoardId = async (
  boardId: number | string
...
export const postPostsBoardIdBump = async (
  boardId: number | string
): Promise<ApiResponse<BoardBumpResponse>> => {
...
/* getPostsMy - 조회 */
export const getPostsMy = async (
  page: number
): Promise<ApiResponse<MyBoardResponse>> => {
...
/* getPostsMyCursor - 조회 */
export const getPostsMyCursor = async (
  cursor?: string
): Promise<ApiResponse<MyBoardCursorResponse>> => {
...
export const getPostsMemberListBoardId = async (
  boardId: number | string
): Promise<ApiResponse<BoardByIdResponseForMember>> => {
...
export const getPostsList = async (
  ...
  try {
    const response = await AuthAxios.get(endpoint, {
      params: { gameMode, tier, mainP, subP, mike },
    });
    return response.data;
  } catch (error) {
...
export const getPostsListBoardId = async (
  boardId: number | string
): Promise<ApiResponse<BoardByIdResponse>> => {
...
export const getPostsCursor = async (
  ...
  position1?: string,
  position2?: string
): Promise<ApiResponse<BoardCursorResponse>> => {
  const endpoint = "/api/v2/posts/cursor";
  try {
    const response = await AuthAxios.get(endpoint, {
      params: { cursor, cursorId, gameMode, tier, position1, position2 },
    });
    return response.data;
  } catch (error) {
