import type { ApiResponse, RefreshTokenRequest, RefreshTokenResponse, LoginRequest, LoginResponse, JoinRequest } from '../types'
import Axios from '@/api'

/* postAuthRefresh - 생성 */
export const postAuthRefresh = async (data: RefreshTokenRequest): Promise<ApiResponse<RefreshTokenResponse>> => {
...
/* postAuthLogin - 생성 */
export const postAuthLogin = async (data: LoginRequest): Promise<ApiResponse<LoginResponse>> => {
...
/* postAuthJoin - 생성 */
export const postAuthJoin = async (data: JoinRequest): Promise<ApiResponse<string>> => {
...
export const getAuthTokenMemberId = async (memberId: number | string): Promise<ApiResponse<string>> => {
