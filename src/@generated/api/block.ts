...
export const postBlockMemberId = async (memberId: number | string): Promise<ApiResponse<BlockResponse>> => {
...
export const deleteBlockMemberId = async (memberId: number | string): Promise<ApiResponse<BlockResponse>> => {
  const endpoint = `/api/v2/block/${memberId}`
  try {
...
/* getBlock - 조회 */
export const getBlock = async (page: number): Promise<ApiResponse<BlockListResponse>> => {
...
export const deleteBlockDeleteMemberId = async (memberId: number | string): Promise<ApiResponse<BlockResponse>> => {
