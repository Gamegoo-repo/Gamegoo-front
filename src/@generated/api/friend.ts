import type { ApiResponse, FriendRequestResponse, StarFriendResponse, FriendListResponse, FriendInfoResponse, DeleteFriendResponse } from '../types'
import { AuthAxios } from '@/api/auth'

/* postFriendRequestMemberId - 생성 */
export const postFriendRequestMemberId = async (memberId: number | string): Promise<ApiResponse<FriendRequestResponse>> => {
...
export const deleteFriendRequestMemberId = async (memberId: number | string): Promise<ApiResponse<FriendRequestResponse>> => {
  const endpoint = `/api/v2/friend/request/${memberId}`
  try {
...
export const patchFriendMemberIdStar = async (memberId: number | string): Promise<ApiResponse<StarFriendResponse>> => {
...
export const patchFriendRequestMemberIdReject = async (memberId: number | string): Promise<ApiResponse<FriendRequestResponse>> => {
...
export const patchFriendRequestMemberIdAccept = async (memberId: number | string): Promise<ApiResponse<FriendRequestResponse>> => {
...
/* getFriendSearch - 조회 */
export const getFriendSearch = async (query: string): Promise<ApiResponse<FriendInfoResponse[]>> => {
...
export const deleteFriendMemberId = async (memberId: number | string): Promise<ApiResponse<DeleteFriendResponse>> => {
