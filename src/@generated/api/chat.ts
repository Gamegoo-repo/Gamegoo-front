import type { ApiResponse, ChatroomListResponse, ChatMessageListResponse, EnterChatroomResponse } from '../types'
import { AuthAxios } from '@/api/auth'

/* patchChatChatroomUuidRead - 업데이트 */
export const patchChatChatroomUuidRead = async (chatroomUuid: number | string, timestamp?: number): Promise<ApiResponse<string>> => {
...
export const patchChatChatroomUuidExit = async (chatroomUuid: number | string): Promise<ApiResponse<any>> => {
...
/* getChatroom - 조회 */
export const getChatroom = async (): Promise<ApiResponse<ChatroomListResponse>> => {
...
export const getChatChatroomUuidMessages = async (chatroomUuid: number | string, cursor?: number): Promise<ApiResponse<ChatMessageListResponse>> => {
...
export const getChatChatroomUuidEnter = async (chatroomUuid: number | string): Promise<ApiResponse<EnterChatroomResponse>> => {
...
export const getChatStartMemberMemberId = async (memberId: number | string): Promise<ApiResponse<EnterChatroomResponse>> => {
...
export const getChatStartBoardBoardId = async (boardId: number | string): Promise<ApiResponse<EnterChatroomResponse>> => {
