...
/* postEmailVerify - 생성 */
export const postEmailVerify = async (data: EmailCodeRequest): Promise<ApiResponse<string>> => {
...
/* postEmailSendPwd - 생성 */
export const postEmailSendPwd = async (data: EmailRequest): Promise<ApiResponse<string>> => {
...
export const postEmailSendJoin = async (data: EmailRequest): Promise<ApiResponse<string>> => {
