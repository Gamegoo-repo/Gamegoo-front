import type { ApiResponse, ChatCreateRequest, ChatCreateResponse } from '../types'
import { AuthAxios } from '@/api/auth'

/* postInternalMemberIdChatChatroomUuid - 생성 */
export const postInternalMemberIdChatChatroomUuid = async (memberId: number | string, chatroomUuid: number | string, data: ChatCreateRequest): Promise<ApiResponse<ChatCreateResponse>> => {
...
export const getInternalMemberIdChatroomUuid = async (memberId: number | string): Promise<ApiResponse<string[]>> => {
